...
Particles.prototype = {
    ...
    imageAreReady: function() {
        if (this.imageReady['js/particles/file_low.png'] === true &&
            this.imageReady['js/particles/file_high.png'] === true) {
            return true;
        }
        return false;
    },
    ...
    init: function() {
        ...
        this.spawnSources = [ this.getTextureFromName("js/particles/file_low.png"),    
                              this.getTextureFromName("js/particles/file_high.png")];
        this.sourceColorTexture = this.getTextureFromName("js/particles/chrome-a_512.png");
...
function drawScene()
{
    if (NotReady) {
        ...
        DefaultImage.src="js/particles/file_low.png";
        NotReady=false;
    }
    if (!Ready) {
        return;
...
function webGLStart(elem) {
    ...
    (function animloop(){
      ...
      window.rAFid = requestAnimFrame(animloop, canvas);
        ...
        $("#about").text("Your browser doesn't support WebGL. Try using a recent version of Chrome or Firefox.");
    }
}
